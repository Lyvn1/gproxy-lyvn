 ...
 * `AppState` wins).
 */
export function init(turso_url: string, turso_token: string, upstash_url?: string | null, upstash_token?: string | null, master_key?: string | null): Promise<void>;
...
export interface InitOutput {
    ...
    readonly init: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
    readonly storage_selftest: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
    readonly __wasm_bindgen_func_elem_28027: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_28048: (a: number, b: number, c: number, d: number) => void;
